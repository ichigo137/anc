...
METADATA_PATH = NOISY_DIR / "metadata.csv"

if not METADATA_PATH.exists():
    raise FileNotFoundError(f"Missing V2 metadata: {METADATA_PATH}")
...
required_columns = {"filename", "base_snr_db"}
missing_columns = required_columns - set(metadata_rows[0].keys())
if missing_columns:
    raise RuntimeError(
